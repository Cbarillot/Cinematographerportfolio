...
contactForm.addEventListener('submit', (e) => {
    ...
    // Simulate API call
    setTimeout(() => {
        showNotification('Votre message a été envoyé avec succès ! Je vous répondrai rapidement.', 'success');
        contactForm.reset();
...
if (playButton && videoPlaceholder) {
    playButton.addEventListener('click', () => {
        ...
        showNotification('Fonction vidéo à implémenter - connecter avec votre plateforme vidéo préférée', 'info');
    });
}
...
portfolioItems.forEach(item => {
    ...
    if (button) {
        button.addEventListener('click', (e) => {
            ...
            showNotification('Ouverture du détail du projet - à implémenter selon vos besoins', 'info');
        });
    }
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Cinematographer Portfolio initialized');
});